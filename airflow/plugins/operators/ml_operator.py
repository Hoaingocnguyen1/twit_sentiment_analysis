...
class ChampionLoaderOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        return load_champion_model(model_name=self.model_name, **context)
...
class ChampionValidationOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        return evaluate_champion_model(
            model_name=self.model_name, min_accuracy=self.min_accuracy, **context
        )
...
class MLPromotionOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        return promote_challenger_to_champion(model_name=self.model_name, **context)
