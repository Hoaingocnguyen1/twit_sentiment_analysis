...
RELOAD_DURATION = Histogram(
    "reload_model_duration_seconds", "Model reload duration", registry=REGISTRY
)
...
ITEM_COUNT = Counter(
    "list_item_count", "Number of items in the sentiment_list", registry=REGISTRY
)
...
async def predict_sentiment(input_data: PredictInput) -> List[int]:
    """
