...
# from app.models import BatchTextInput, SentimentResponse, ErrorResponse
...
#     try:
#         # Get prediction
#         result = model_manager.predict_batch([input_data.text])
...
#         logger.debug(f"Received texts for prediction: {texts}")
